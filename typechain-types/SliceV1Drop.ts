...
export interface SliceV1DropInterface extends utils.Interface {
  contractName: "SliceV1Drop";
  functions: {
...
export interface SliceV1Drop extends BaseContract {
  contractName: "SliceV1Drop";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SliceV1DropInterface;
